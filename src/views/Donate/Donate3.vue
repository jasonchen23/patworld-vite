            ...
            <div class="card">
              ...
              <form>
                <div class="row mb-3 mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputName" placeholder="必填" aria-label="readonly input example" readonly v-model="name">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPhone" class="col-sm-2 col-form-label">電話號碼</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPhone" placeholder="必填" aria-label="readonly input example" readonly v-model="phone">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">電子郵件</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail" placeholder="必填" aria-label="readonly input example" readonly v-model="email">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <router-link to="/donate/done">
                  <button class="button-30 mt-5" type="summit" @click="donate">送出</button>
                </router-link>
