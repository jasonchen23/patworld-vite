...
<Form class="d-grid p-4 text-end" @submit="onSubmit">
    <Field name="account" type="text" :rules="isRequired" class="form-control" placeholder="帳號" v-model="account" />
    ...
    <Field name="phone" type="number" :rules="isRequired" class="form-control mt-3" placeholder="行動電話" />
    <ErrorMessage name="phone" class="text-danger" />
    <Field name="address" type="text" :rules="isRequired" class="form-control mt-3" placeholder="地址" />
    <ErrorMessage name="address" class="text-danger" />
    <Field name="job" as="select" :rules="isRequired" class="form-select mt-3">
    ...
    <Field name="email" type="email" :rules="validateEmail" class="form-control mt-3" placeholder="Email" />
    <ErrorMessage name="email" class="text-danger" />
    <Field name="age" type="number" :rules="isRequired" class="form-control mt-3" placeholder="年紀" />
